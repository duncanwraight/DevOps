    ...
    def build_hostnames(self, changed_hosts):
        ...
        for host in changed_hosts:
            if host[0] == "-":
                ...
                next_host_id += 1
                # DWR CHANGE - ip parameter causes kubespray to fail "ansible_all_ipv4_addresses" assertion
                #all_hosts[next_host] = "ansible_host={0} ip={1}".format(host, host)
                all_hosts[next_host] = "ansible_host={0}".format(host)
            elif host[0].isalpha():
