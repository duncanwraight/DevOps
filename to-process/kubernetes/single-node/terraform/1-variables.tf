...
locals {
  ...
  prefix_group      = "HG-${var.project}-${var.environment}"
  prefix_specific   = "HG-${var.project}-##TYPE##-${var.environment}"
  prefix_alpha      = "HG${format("%.6s", var.project)}##TYPE##${var.environment}"
