...
az webapp create --name "$WebApp" --plan "$AppServicePlan" --resource-group "$AppServiceResourceGroup" --deployment-container-image-name "${PushAcrURL}/hg-mha-html-pages" --tags $Tags --output jsonc
